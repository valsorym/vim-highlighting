...
syn keyword pythonStatement     str int unicode tuple dict list
syn keyword pythonStatement     and assert break class continue def del dir
syn keyword pythonStatement     elif else except exec finally for from
syn keyword pythonStatement     global if import in is lambda len not
syn keyword pythonStatement     or pass print raise return try type while
